...
<body>
    ...
    <div id="home" class="panel" selected="true"> 
        ...
        <?php echo form_open(site_url() . '/contact/add_contact', array('class' => 'panel')); /**<img src="<?php echo base_url()?>/img/image001.jpg" border="1" width="395" />*/ ?>
                <h2>Full name:
                    <?php echo form_input(array('id' => 'name', 'name' => 'name', 'size' => 20, 'style' => 'font-size:20px')); ?>
                </h2>     
                
                <h2>
                Position:
                    <?php echo form_input(array('id' => 'position', 'name' => 'position', 'size' => 20, 'style' => 'font-size:20px')); ?>
                </h2>
                
                <h2>
                Company:
                    <?php echo form_input(array('id' => 'company', 'name' => 'company', 'size' => 20, 'style' => 'font-size:20px')); ?>
                </h2>
                
                <h2>
                Cellphone:
                    <?php echo form_input(array('id' => 'cellphone', 'name' => 'cellphone', 'size' => 20, 'style' => 'font-size:20px')); ?>
                </h2>
                <h2>
                Office Address:
                    <?php echo form_input(array('id' => 'office_address', 'name' => 'office_address', 'size' => 20, 'style' => 'font-size:20px')); ?>
                </h2>
                <h2>
                Email:
                    <?php echo form_input(array('id' => 'email', 'name' => 'email', 'size' => 20, 'style' => 'font-size:20px')); ?>
                </h2>
                ...
                <br/>
                <center>
                    <button type="submit" class="button" style="height: 30px; width: 100px; top: auto; right: auto; position: relative; ">Add contact</button> <button type="reset" class="button" style="height: 30px; width: 100px; top: auto; right: auto; position: relative; ">Reset</button>
