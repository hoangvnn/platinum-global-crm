...
<body>
	...
	<div id="login_form"> 
        <?php echo form_open(site_url() . '/user/login'); /**<img src="<?php echo base_url()?>/img/image001.jpg" border="1" width="395" />*/ ?>
        
        <h1>Platinum Global CRM</h1>
		<center><p> Use the form below to login to our site</p></center>
        <ul>
            <li>
