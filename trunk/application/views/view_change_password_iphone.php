...
<body>
    ...
    <div id="home" class="panel" selected="true"> 
        ...
        <?php echo form_open(site_url() . 'user/changing_password', array('class' => 'panel')); /**<img src="<?php echo base_url()?>/img/image001.jpg" border="1" width="395" />*/ ?>
                <h2>Old password:
                    <?php echo form_password(array('id' => 'old_pass',  'name' => 'old_pass', 'size' => 20, 'style' => 'font-size:20px')); ?>
                </h2>     
                
                <h2>
                New password:
                    <?php echo form_password(array('id' => 'new_pass', 'name' => 'new_pass', 'size' => 20, 'style' => 'font-size:20px')); ?>
                </h2>
                
                <h2>
                Retype new password:
                    <?php echo form_password(array('id' => 'retype_pass', 'name' => 'retype_pass', 'size' => 20, 'style' => 'font-size:20px')); ?>
                </h2>
                ...
                <h2 style="text-align: center;">
                     <?php
                        if ($this->session->flashdata('add_error'))
                           echo 'You have mistyped the old password. Pls try again!';
                        echo validation_errors(); 
                     ?>
                     <?php
                        if ($this->session->flashdata('add_ok'))
                           echo 'You have changed your password successful!'; 
                     ?>
                </h2>
                <br/>
                <center>
